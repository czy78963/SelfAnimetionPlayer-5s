...
- (void)loadContrellers {
    ...
    if ([[NSUserDefaults standardUserDefaults] boolForKey:@"didLogin"]) {
        ...
        NSString *key = [NSString stringWithFormat:@"av%@%@",_avNumber,str];
        ...
        if (![[NSUserDefaults standardUserDefaults] objectForKey:key]) {
            ...
            [NetRequest GET:[NSString stringWithFormat:@"%@%@",URL_OF_VEDIO_MASSAGE,_avNumber] parameters:nil success:^(id resposeObject) {
                ...
                dispatch_async(dispatch_get_main_queue(), ^{
                    ...
                    NSMutableArray *arrForKeys = [[[NSUserDefaults standardUserDefaults] objectForKey:strKeyNew] mutableCopy];
                    //                NSLog(@"%@",arrForKeys);
                    [arrForKeys addObject:key];
                    //                NSLog(@"%@",arrForKeys);
                    [[NSUserDefaults standardUserDefaults] setObject:arrForKeys forKey:strKeyNew];
                    [[NSUserDefaults standardUserDefaults] synchronize];
